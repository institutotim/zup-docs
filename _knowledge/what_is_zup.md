...
Em termos de diferentes elementos, o ZUP é composto pelos seguintes componentes:

* Aplicativo Android Cidadão
* Aplicativo Android Técnico
* Aplicativo IOS Cidadão
* Painel Administrativo Web
* Página Pública do projeto (landing page)
* Painel de inserção e acompanhamento de demandas Cidadão
